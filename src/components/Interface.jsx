...
import { PlayArrow, Settings, Movie, Pause, Replay,ViewList } from "@mui/icons-material";
            ...
            <div className={`nav-right ${cinematic ? "cinematic" : ""}`}>
                ...
                <Tooltip title="Open settings">
                    <IconButton onClick={() => {setSidebar(true);}} style={{ backgroundColor: "#2A2B37", width: 36, height: 36 }} size="large">
                        <ViewList style={{ color: "#fff", width: 24, height: 24 }} fontSize="inherit" />
                    </IconButton>
                </Tooltip>
            ...
            >
                <div className="tutorial-container">
                    ...
                    <div className="content">
                        <h1>Search Algorithm Usage in Real World Map</h1>
                        {activeStep === 0 && <div>
                            <p>
                                <b>Controls:</b> <br/>
